 ...
 *
 */
public class ModelRendererTurbo_old {
	/**
	 ...
	 */
	public ModelRendererTurbo_old(ModelBase modelbase, int offsetX, int offsetY, int textureX, int textureY) {
	...
	public void addShape3D(float x, float y, float z, Shape2D shape, float depth, int shapeTextureWidth,
			int shapeTextureHeight, int sideTextureWidth, int sideTextureHeight, float rotX, float rotY, float rotZ,
			float[] faceLengths) {
		Coord2D[] coords = shape.coords.toArray(new Coord2D[0]);
	...
	public ModelRendererTurbo_old addBox(float x, float y, float z, int w, int h, int d) {
